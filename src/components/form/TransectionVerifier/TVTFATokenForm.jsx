...
const TVTwoFATokenForm = () => {
  ...
  return (
    <Card className="w-[600px] h-[661px] bg-[#FFFFFF] shadow-inner py-[34px]  p-[59px]">
...
export default TVTwoFATokenForm;
